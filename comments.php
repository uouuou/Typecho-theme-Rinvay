...
<div id="<?php $this->respondId(); ?>" class="comment-container">
    <div id="comments" class="clearfix">
        ...
        <?php if ($this->allow('comment')): ?>
            ...
            <?php else: ?>
                <span class="response">评论<?php if ($this->user->hasLogin()): ?> / 尊敬的会员
                        <a href="<?php $this->options->profileUrl(); ?>" data-no-instant><?php $this->user->screenName(); ?></a>, 你想要

                        <a href="<?php $this->options->logoutUrl(); ?>" title="Logout" data-no-instant>退出</a> 吗?<?php endif; ?> <?php $comments->cancelReply(' / Cancel Reply'); ?></span>
