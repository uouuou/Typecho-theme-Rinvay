        ...
        <div class="post-header-thumb-cover">
            <div class="post-header-thumb-container">
                ...
                <div class="post-header-thumb-meta">
                    ...
                    in <?php $this->category(''); ?> with
                    <a href="#comments"><?php $this->commentsNum(_t(' 0 comment'), _t(' 1 comment'), _t(' %d comments')); ?></a>
                </div>
                <div class="post-tags">
                    <?php $this->tags(' ', true, ''); ?>
                </div>
...
<?php else : ?>
    ...
    <article class="main-content <?php if ($this->options->postshowthumb == 'able'): ?>post-page<?php else: ?>page-page<?php endif; ?>" itemscope itemtype="http://schema.org/Article">
        ...
        <div id="post-content" class="post-content" itemprop="articleBody">
            ...
            <p class="post-info">
                本文由 <a href="<?php $this->author->permalink(); ?>"><?php $this->author() ?></a> 创作，采用
