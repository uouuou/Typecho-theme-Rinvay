...
$rinvay.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function(a, c, d) {
    if (d.get || d.set)
        throw new TypeError("owo");
    a != Array.prototype && a != Object.prototype && (a[c] = d.value)
}
;
$rinvay.getGlobal = function(a) {
    return "undefined" != typeof window && window === a ? a : "undefined" != typeof global && null != global ? global : a
}
;
$rinvay.global = $rinvay.getGlobal(this);
$rinvay.SYMBOL_PREFIX = "rinvay_symbol_";
$rinvay.initSymbol = function() {
    $rinvay.initSymbol = function() {}
    ;
    $rinvay.global.Symbol || ($rinvay.global.Symbol = $rinvay.Symbol)
}
;
$rinvay.symbolCounter_ = 0;
$rinvay.Symbol = function(a) {
    return $rinvay.SYMBOL_PREFIX + (a || "") + $rinvay.symbolCounter_++
}
;
$rinvay.initSymbolIterator = function() {
    $rinvay.initSymbol();
    var a = $rinvay.global.Symbol.iterator;
    a || (a = $rinvay.global.Symbol.iterator = $rinvay.global.Symbol("iterator"));
    "function" != typeof Array.prototype[a] && $rinvay.defineProperty(Array.prototype, a, {
        configurable: !0,
        writable: !0,
        value: function() {
            return $rinvay.arrayIterator(this)
        }
    });
    $rinvay.initSymbolIterator = function() {}
}
;
$rinvay.arrayIterator = function(a) {
    var c = 0;
    return $rinvay.iteratorPrototype(function() {
        return c < a.length ? {
            done: !1,
            value: a[c++]
        } : {
...
;
$rinvay.iteratorPrototype = function(a) {
    $rinvay.initSymbolIterator();
    a = {
        next: a
    };
    a[$rinvay.global.Symbol.iterator] = function() {
        return this
    }
    ;
    return a
...
;
$rinvay.array = $rinvay.array || {};
$rinvay.iteratorFromArray = function(a, c) {
    $rinvay.initSymbolIterator();
...
;
$rinvay.polyfill = function(a, c, d, b) {
    if (c) {
        d = $rinvay.global;
        a = a.split(".");
        ...
        b = d[a];
        c = c(b);
        c != b && null != c && $rinvay.defineProperty(d, a, {
            configurable: !0,
            writable: !0,
            value: c
        })
...
;
$rinvay.polyfill("Array.prototype.keys", function(a) {
    return a ? a : function() {
        return $rinvay.iteratorFromArray(this, function(a) {
            return a
        })
    }
}, "owo", "OWO");
(function() {
    var a = function(a) {
        var d = this, b = {
            ...
            // style: "max-width: 100%;",
            maxHeight: "250px",
            api: "https://www.rinvay.cc/usr/themes/Rinvay/js/OwO.json"
        }, c;
        for (c in b)
        ...
        e.onreadystatechange = function() {
            4 === e.readyState && (200 <= e.status && 300 > e.status || 304 === e.status ? (d.odata = JSON.parse(e.responseText),
            d.init(a)) : console.log("OwO data request was unsuccessful: " + e.status))
        }
        ;
        e.open("get", a.api, !0);
        e.send(null)
    ...
    a.prototype.init = function(a) {
        ...
        for (var b = '\n            <div class="OwO-logo"><span>' + a.logo + '</span></div>\n            <div class="OwO-body" style="' + a.style + '">', c = 0; c < this.packages.length; c++) {
            ...
            if ("biaoqing" === this.odata[this.packages[c]].type) {
                var e = this.odata[this.packages[c]].baseURL
                  , h = this.odata[this.packages[c]].suffix
                  , m = this.odata[this.packages[c]].input
                  , g = this.odata[this.packages[c]].retinaSuffix
                  , n = this.odata[this.packages[c]].imgClass
                  , k = this.odata[this.packages[c]].container;
                ...
                for (g = 0; g < k.length; g++)
                    var p = '<img data-src="' + (e + encodeURI(k[g]).replace(/%/g, "") + h) + '" title="' + k[g] + '">'
                      , l = m.replace("{NAME}", k[g])
                      , l = "{IMG_TAG}" !== m ? 'data-input="' + l + '"' : ""
                      , b = b + ('\n                    <li class="OwO-item" title="' + k[g] + '" ' + l + ">" + p + "</li>")
            } else
                for (e = this.odata[this.packages[c]].container,
                h = 0; h < e.length; h++)
        ...
        for (a = 0; a < this.packages.length; a++)
            b += "\n                        <li><span class=\"OwO-span\">" + this.packages[a] + "</span></li>";
        ...
        for (b = {
            i$4: 0
        }; b.i$4 < this.packagesEle.children.length; b = {
            i$4: b.i$4
        },
        b.i$4++)
            (function(a) {
    ...
    a.prototype.moveCaretRange = function(a) {
        if (this.area.setSelectionRange)
            this.area.focus(),
            this.area.setSelectionRange(a, a);
    ...
    a.prototype.toggle = function(a) {
        ...
        this.container.classList.contains("OwO-open") ? (this.container.classList.remove("OwO-open"),
        document.getElementsByTagName("body")[0].classList.remove("OwO-open")) : (this.container.classList.add("OwO-open"),
